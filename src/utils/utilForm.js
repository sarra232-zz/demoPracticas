...
const getEvents = eventArray => {
  ...
  const eventDate = `Fecha de evento: ${Object.values (eventArray)[0].eventdate.substring (0, 10)}`;
  const description = `Descripción: ${Object.values (eventArray)[0].description}`;
